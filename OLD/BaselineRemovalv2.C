...
static const int avg_pre_samples[4] = {5, 5, 5, 5};
static const int avg_post_samples[4] = {4, 4, 4, 4};
static const int trig_pre_samples[4] = {3, 3, 5, 10};
static const int trig_post_samples[4] = {5, 5, 10, 60};
static const int UnTrigSettleLength[4] = {5, 5, 8, 8};

class BaselineRemovalv2 : public TSelector {
public :
  ...
  TBranch     *TimeBranch;
   ...
   BaselineRemovalv2(TTree * = 0):
     nentries(0),AcqNum(0), AcqNumInSpill(0), MaxCh3(0)
  {

     printf("Calling BaselineRemovalv2 Constructor...\n");
  ...
  ClassDef(BaselineRemovalv2,0);
};

void BaselineRemovalv2::Init(TTree *tree)
{
  // The Init() function is called when the selector needs to initialize
  // a new tree or chain. Typically here the branch addresses and branch
  // pointers of the tree will be set.
  printf("Initialising BaselineRemovalv2!\n");
...
void BaselineRemovalv2::SlaveBegin(TTree *tree)
{
   ...
   printf("Calling BaselineRemovalv2::SlaveBegin\n");

   TString option = GetOption();

   //Define the ResultTree
   ChnFile = new TFile("BLsubtractedv2.root", "RECREATE");
...
//TimeAfterTrigHisto = new TH1D("TimeAfterTrigHisto",
   ...
   //ResultTree->Branch("BaselineOKAfterThisIdxCh0", &BLisOK_ch0,
   //		      "BaselineOKAfterThisIdxCh0/s");
   //ResultTree->Branch("BaselineOKAfterThisIdxCh1", &BLisOK_ch1,
   //		      "BaselineOKAfterThisIdxCh1/s");
   //ResultTree->Branch("BaselineOKAfterThisIdxCh2", &BLisOK_ch2,
   //		      "BaselineOKAfterThisIdxCh2/s");
   //ResultTree->Branch("BaselineOKAfterThisIdxCh3", &BLisOK_ch3,
   //		      "BaselineOKAfterThisIdxCh3/s");
}

void BaselineRemovalv2::BLsub(int chn,
...
Bool_t BaselineRemovalv2::Process(Long64_t entry)
{
...
void BaselineRemovalv2::Terminate()
{
