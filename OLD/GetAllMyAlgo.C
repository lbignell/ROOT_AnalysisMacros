// THIS IS A MACRO, DON'T TRY TO COMPILE!
{
  ...
  //TheChain1->Process("SimpleSumIntegral.C+");
  //TFile* f1 = new TFile("SimpleIntegral.root");
  ...
  //TheChain2->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain2->Process("SimpleSumIntegral.C+");
  //TFile* f2 = new TFile("SimpleIntegral.root");
  //Results->Process("DimaBaselineRemoval.C+");
  ...
  //  TheChain3->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain3->Process("SimpleSumIntegral.C+");
  //TFile* f3 = new TFile("SimpleIntegral.root");
  //Results->Process("DimaBaselineRemoval.C+");
  ...
  //TheChain4->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain4->Process("SimpleSumIntegral.C+");
 ...
 // gSystem->Exec("echo New Data set! The time is...");
  ...
  //TheChain5->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain5->Process("SimpleSumIntegral.C+");
  ...
  //TheChain6->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain6->Process("SimpleSumIntegral.C+");
  ...
  // TheChain7->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain7->Process("SimpleSumIntegral.C+");
  ...
  //TheChain8->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain8->Process("SimpleSumIntegral.C+");
  ...
  //TheChain9->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain9->Process("SimpleSumIntegral.C+");
  ...
  //TheChain10->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain10->Process("SimpleSumIntegral.C+");
  ...
  //TheChain11->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain11->Process("SimpleSumIntegral.C+");
//TFile* f11 = new TFile("SimpleIntegral.root");
  ...
  //TheChain12->Add(TString::Format("rootoutputfile%i.root",num));
  //}
  //TheChain12->Process("SimpleSumIntegral.C+");
 ...
 for(int num = 6426; num<6427; num++){
   TheChain13->Add(TString::Format("rootoutputfile%i.root",num));
 }
 TheChain13->Process("SimpleSumIntegral.C+");
