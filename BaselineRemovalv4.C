...
class BaselineRemovalv4 : public TSelector {
public :
  ...
  TBranch     *TimeBranch;
   ...
   BaselineRemovalv4(TTree * = 0):
     nentries(0),AcqNum(0), AcqNumInSpill(0), MaxCh3(0)
  {

     printf("Calling BaselineRemovalv4 Constructor...\n");
  ...
  virtual ~BaselineRemovalv4() {
    printf("Calling BaselineRemovalv4 destructor... \n");
  }
  ...
  ClassDef(BaselineRemovalv4,0);
};

void BaselineRemovalv4::Init(TTree *tree)
{
  // The Init() function is called when the selector needs to initialize
  // a new tree or chain. Typically here the branch addresses and branch
  // pointers of the tree will be set.
  printf("Initialising BaselineRemovalv4!\n");
...
void BaselineRemovalv4::SlaveBegin(TTree *tree)
{
   ...
   printf("Calling BaselineRemovalv4::SlaveBegin\n");

   TString option = GetOption();

   //Define the ResultTree
   ChnFile = new TFile("BLsubtractedv4.root", "RECREATE");
...
void BaselineRemovalv4::BLsub(int chn,
...
Bool_t BaselineRemovalv4::Process(Long64_t entry)
{
...
void BaselineRemovalv4::Terminate()
{
