...
class AvgWfmAndBaselineRemovalv3p6 : public TSelector {
public :
  ...
  TBranch     *TimeBranch;
   ...
   AvgWfmAndBaselineRemovalv3p6(TTree * = 0):
     nentries(0),AcqNum(0), AcqNumInSpill(0), MaxCh3(0)
  {

     printf("Calling AvgWfmAndBaselineRemovalv3p6 Constructor...\n");
  ...
  virtual ~AvgWfmAndBaselineRemovalv3p6() {
    printf("Calling AvgWfmAndBaselineRemovalv3p6 destructor... \n");
  }
  ...
  ClassDef(AvgWfmAndBaselineRemovalv3p6,0);
};

void AvgWfmAndBaselineRemovalv3p6::Init(TTree *tree)
{
  // The Init() function is called when the selector needs to initialize
  // a new tree or chain. Typically here the branch addresses and branch
  // pointers of the tree will be set.
  printf("Initialising AvgWfmAndBaselineRemovalv3p6!\n");
...
void AvgWfmAndBaselineRemovalv3p6::SlaveBegin(TTree *tree)
{
   ...
   printf("Calling AvgWfmAndBaselineRemovalv3p6::SlaveBegin\n");
...
void AvgWfmAndBaselineRemovalv3p6::BLsub(int chn,
...
Bool_t AvgWfmAndBaselineRemovalv3p6::Process(Long64_t entry)
{
...
void AvgWfmAndBaselineRemovalv3p6::Terminate()
{
