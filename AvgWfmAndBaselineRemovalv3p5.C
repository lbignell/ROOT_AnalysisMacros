...
///////////////////////////////////////////////////////////////////////////////
//Alternate values -- after threshold study.
static const double avg_baseline[4] = {8133, 8166, 8165, 8000};
static const double max_amplitude[4] = {15, 17, 50, 100};
static const int avg_pre_samples[4] = {4, 4, 4, 4};
static const int avg_post_samples[4] = {4, 4, 4, 4};
static const int trig_pre_samples[4] = {10, 10, 10, 10};
static const int trig_post_samples[4] = {10, 10, 10, 60};
...
class AvgWfmAndBaselineRemovalv3p5 : public TSelector {
public :
  ...
  TBranch     *TimeBranch;
   ...
   AvgWfmAndBaselineRemovalv3p5(TTree * = 0):
     nentries(0),AcqNum(0), AcqNumInSpill(0), MaxCh3(0)
  {

     printf("Calling AvgWfmAndBaselineRemovalv3p5 Constructor...\n");
  ...
  virtual ~AvgWfmAndBaselineRemovalv3p5() {
    printf("Calling AvgWfmAndBaselineRemovalv3p5 destructor... \n");
  }
  ...
  ClassDef(AvgWfmAndBaselineRemovalv3p5,0);
};

void AvgWfmAndBaselineRemovalv3p5::Init(TTree *tree)
{
  // The Init() function is called when the selector needs to initialize
  // a new tree or chain. Typically here the branch addresses and branch
  // pointers of the tree will be set.
  printf("Initialising AvgWfmAndBaselineRemovalv3p5!\n");
...
void AvgWfmAndBaselineRemovalv3p5::SlaveBegin(TTree *tree)
{
   ...
   printf("Calling AvgWfmAndBaselineRemovalv3p5::SlaveBegin\n");
...
void AvgWfmAndBaselineRemovalv3p5::BLsub(int chn,
...
Bool_t AvgWfmAndBaselineRemovalv3p5::Process(Long64_t entry)
{
...
void AvgWfmAndBaselineRemovalv3p5::Terminate()
{
